...
curl_setopt($ch, CURLOPT_URL, 'http://www.simi-api.com/ApiSimiweb/response/v2.1.3/filtroInmueble/limite/' . $pag . '/total/12/departamento/0/ciudad/' . $ci . '/zona/0/barrio/' . $zo . '/tipoInm/' . $ti . '/tipOper/' . $gs . '/areamin/' . $armin . '/areamax/' . $armax . '/valmin/' . $min . '/valmax/' . $max . '/campo/0/order/desc/banios/' . $ba . '/alcobas/' . $al . '/garajes/' . $par . '/sede/0/usuario/0');
...
// curl_setopt($ch2, CURLOPT_URL, 'http://www.simi-api.com/ApiSimiweb/response/v2.1.3/filtroInmueble/limite/' . $pag . '/total/12/departamento/0/ciudad/' . $ci . '/zona/0/barrio/' . $zo . '/tipoInm/' . $ti . '/tipOper/' . $gs . '/areamin/' . $armin . '/areamax/' . $armax . '/valmin/' . $min . '/valmax/' . $max . '/campo/0/order/desc/banios/' . $ba . '/alcobas/' . $al . '/garajes/' . $par . '/sede/0/usuario/0');
...
function modeloInmueble($r, $url, $r2)
{
    ...
    if (is_array($r)) {
        ...
        <div class="image" style="width: 100%;"><a href="' . $url . 'descripcion-del-inmueble/codigo/' . $api['Codigo_Inmueble'] . '">
    ...
    //         $r2[$i]['foto1'] = existeImagen($r2[$i]['foto1'], $url);
    //         $api = $r2[$i];
    //         $api['Codigo_Inmueble'] = str_ireplace("618-", "", $api['Codigo_Inmueble']);
    //         echo '
    //     <div class="item col-sm-4">
    //     <div class="image" style="width: 100%;"><a href="' . $url . 'descripcion-del-inmueble/codigo/' . $api['Codigo_Inmueble'] . '/sur">
    //     <h3>' . $api['Tipo_Inmueble'] . '<br>Estrato: ' . $api['Estrato'] . '</h3><span class="location">Barrio: ' . $api['Barrio'] . '</span></a>
    //     <img src="' . $api['foto1'] . '" alt="" id="foto-inmueble"></div>
    //     <div class="price">
    //     <i class="fa fa-home"></i>' . $api['Gestion'] . '';
