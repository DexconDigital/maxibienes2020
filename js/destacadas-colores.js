...
$.ajax({
    url: 'https://www.simi-api.com/ApiSimiweb/response/v21/inmueblesDestacados/total/1/limit/0/sede/12063',
     type: 'GET',
     ...
     success:function(data){
        ...
        console.log(totalInmuebles);
         $.ajax({
               url: 'https://www.simi-api.com/ApiSimiweb/response/v21/inmueblesDestacados/total/'+totalInmuebles+'/limit/0/sede/12063',
                type: 'GET',
                beforeSend: function (xhr) {
                xhr.setRequestHeader(
                   'Authorization',
                ...
                success: function (data) {
                    ...
                    if (data == "Sin resultados") {
                        ...
                        var pos = 0;
                        console.log('Hola no soy yo eres tu ');
