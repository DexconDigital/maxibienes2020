...
$.ajax({
    url: 'https://www.simi-api.com/ApiSimiweb/response/v21/inmueblesDestacados/total/1/limit/0/sede/12065',
     type: 'GET',
     ...
     success:function(data){
        ...
        console.log(totalInmuebles);
         $.ajax({
               url: 'https://www.simi-api.com/ApiSimiweb/response/v21/inmueblesDestacados/total/'+totalInmuebles+'/limit/0/sede/12065',
                type: 'GET',
                beforeSend: function (xhr) {
                xhr.setRequestHeader(
                   'Authorization',
