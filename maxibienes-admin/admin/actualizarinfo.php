...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <?php
            $id=$_GET["id"];
            $con=Conect();
            $qry="SELECT * FROM informacion where id ='$id'";
            $sql=mysqli_query($con,$qry);
            $res=  mysqli_fetch_array($sql) ;                            
        ?>
        <div id="page-wrapper">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="update_info.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control1" id="titulo" type="text" name="titulo" value="<?php echo $res[3]; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">Contenido</label>
                        <div class="col-sm-8">
                        <textarea name="contenido"  id="contenido"><?php echo $res[1]; ?></textarea>
                    ...
                    <div class="form-group"  style="display:none;" >
                        ...
                        <div class="col-sm-8" >
                            <input type="text" class="form-control1" name="zona" value="<?php echo $res[2]; ?>" id="zona">
                        </div>
                    </div>
