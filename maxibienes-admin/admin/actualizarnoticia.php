            ...
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="update2.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control1" name="nameUrl" id="nombreUrl" placeholder="" value ="<?php echo $res[8];?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="noticia" class="col-sm-2 control-label">Meta description</label>
                                <div class="col-sm-8">
                                    <textarea name='description' id="description" class="form-control1" style="height:100px;" aria-describedby="keywordsHelp"> <?php echo $res[7];?> </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="noticia" class="col-sm-2 control-label">keywords</label>
                                <div class="col-sm-8">
                                    <textarea name="keywords" id="keywords" class="form-control1" style="height:100px;" aria-describedby="keywordsHelp"><?php echo $res[6];?></textarea>
                                </div>
                            </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control1" name="altimg" id="altimg" placeholder="" value="<?php echo $res[9];?>" required>
                                </div>
                    </div>
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn-success btn">Actualizar Publicacion</button>
