                ...
                <div class="panel-body no-padding">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php 
                            $con=Conect();
                            $qry="select * from imagenes order by id DESC    ";
                            $sql=mysqli_query($con,$qry);
                            while($res=  mysqli_fetch_array($sql)){
                                ...
                                <td><a href="actualizarimagen.php?id='.$res["id"].'&zona='.$res["zona"].'"><i class="fa fa-refresh style="color:#fff;" nav_icon"></i></a></td>
                                
                            </tr>';

                                }else if($res["zona"]==2){
                                    echo '<tr>
                                <td>Nuestra Compañia</td>
                                <td><img src="'.$res["imagen"].'" class="img-listado" /></td>
                                <td><a href="actualizarimagen.php?id='.$res["id"].'&zona='.$res["zona"].'"><i class="fa fa-refresh style="color:#fff;" nav_icon"></i></a></td>
                                   </tr>';
                                }
