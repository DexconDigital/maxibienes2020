...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <?php
            $id=$_GET["id"];
            $con=Conect();
            $qry="SELECT * FROM contacto where id ='$id'";
            $sql=mysqli_query($con,$qry);
            $res=  mysqli_fetch_array($sql) ;                            
        ?>
        <div id="page-wrapper">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="update_contact.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control1" id="celular" type="text" name="celular" value="<?php echo $res[1]; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">Correo</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="correo" id="correo" value="<?php echo $res[2]; ?>"  required>
                        </div>
                    </div>
