...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <?php
            $id=$_GET["id"];
            $con=Conect();
            $qry="SELECT * FROM infoimg where id ='$id'";
            $sql=mysqli_query($con,$qry);
            $res=  mysqli_fetch_array($sql) ;                            
        ?>
        <div id="page-wrapper">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="update_infoimg.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control1" id="titulo" type="text" name="titulo" value="<?php echo $res[2]; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">Contenido</label>
                        <div class="col-sm-8">
                        <textarea name="contenido"  id="contenido"><?php echo $res[3]; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        if($res[4]==1){
                            echo "Zona Interactiva(Inicio)"; 
                        }
                        else if($res[4]==2){
                            echo "Servicios"; 
                        }
                        else if($res[4]==3){
                            echo "Zona Pagos(inicio)"; 
                        }
                    ...
                    <div class="form-group"  style="display:none;" >
                        <label for="focusedinputw" class="col-sm-2 control-label">Ubicación</label>
                        <div class="col-sm-8" >
                            <input type="text" class="form-control1" name="zona" value="<?php echo $res[4]; ?>" id="zona">
                        </div>
                    </div>
                    <div class="form-group" id="url" >
                            <label for="focusedinput" class="col-sm-2 control-label">Url de enlace</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="link" id="link" value="<?php echo $res[5];?>" placeholder="" >
                            </div>
                        </div>
                    <div class="form-group">
