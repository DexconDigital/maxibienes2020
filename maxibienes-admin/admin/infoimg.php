...
<div id="wrapper">
    ...
    <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                <div class="panel-body no-padding">
                    <h4>Gestión de Información con Imagen</h4>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php 
                            $con=Conect();
                            $qry="select * from infoimg order by id DESC    ";
                            $sql=mysqli_query($con,$qry);
                            while($res=  mysqli_fetch_array($sql)){
                                ...
                                <td>'.$res["nombre"].'</td>
                                <td>'.$res["contenido"].'</td>
                                <td>Zona Interactiva(Inicio)</td>
                                <td><img src="'.$res["imagen"].'" class="img-listado" /></td>
                                <td>'.$res["link"].'</td>
                                <td><a href="actualizarinfoimg.php?id='.$res["id"].'"><i class="fa fa-refresh style="color:#fff;" nav_icon"></i></a></td>
                                <td><a href="#" data-href="eliminar_infoimg.php?id='.$res["id"].'" data-toggle="modal" data-target="#confirm-delete" ><i class="fa fa-times style="color:#fff;" nav_icon"></i></a></td>
                            </tr>';
