...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <?php
            $id=$_GET["id"];
            $con=Conect();
            $qry="SELECT * FROM links where id ='$id'";
            $sql=mysqli_query($con,$qry);
            $res=  mysqli_fetch_array($sql) ;                            
        ?>
        <div id="page-wrapper">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="update_link.php" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Facebook</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="facebook" id="facebook" value="<?php echo $res[2];?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Youtube</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="youtube" id="youtube" value="<?php echo $res[4];?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Twitter</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="twitter" id="twitter" value="<?php echo $res[3];?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Instagram</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="instagram" id="instagram" value="<?php echo $res[5];?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Whatsapp</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="whatsapp" id="whatsapp" value="<?php echo $res[6];?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Pse Medellin</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="pse" id="pse" value="<?php echo $res[1];?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="noticia" class="col-sm-2 control-label">Pse Sur</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control1" name="seg_pse" id="seg_pse" value="<?php echo $res[7];?>">
                        </div>
                    </div>
