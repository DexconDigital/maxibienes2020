...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="col-md-12 graphs">
            ...
            <h3>Agregar Imagenes de Aliados</h3>
      
                <div class="tab-pane active" >
     
                <form class="form-horizontal" method="post" action="guardar_imagen.php" enctype="multipart/form-data">
                        
                        <div class="form-group" style="display:none">
                            <label for="disabledinput" class="col-sm-2 control-label">Ubicación en la Pagina</label>
                            <div class="col-sm-3">
                            <input type="text" class="form-control1" name="zona" id="zona"  placeholder="" value="3">
                            </div>
                        </div>
