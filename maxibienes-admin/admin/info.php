                ...
                <div class="panel-body no-padding">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php 
                            $con=Conect();
                            $qry="select * from informacion order by id DESC    ";
                            $sql=mysqli_query($con,$qry);
                            while($res=  mysqli_fetch_array($sql)){
                                ...
                                <td><a href="actualizarinfo.php?id='.$res["id"].'"><i class="fa fa-refresh style="color:#fff;" nav_icon"></i></a></td>
                            </tr>';
