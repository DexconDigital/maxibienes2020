                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="asesor.php">Listar Información con imagenes</a>
                                </li>
                                <li>
            ...
            <div class="col-md-12 graphs">
                <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}"
                    ...
                    <div class="panel-body no-padding">
                        <h4>Gestión de Información de Asesores</h4>
                        <table class="table table-striped">
                            ...
                            while($res=  mysqli_fetch_array($sql)){
                                ...
                                <td>San Juan</td>
                                <td>Arriendo</td>
                                <td><img src="'.$res["foto"].'" class="img-asesor" /></td>
                                <td><a href="#" data-href="eliminar_asesor.php?id='.$res["id"].'" data-toggle="modal" data-target="#confirm-delete" ><i class="fa fa-times style="color:#fff;" nav_icon"></i></a></td>
                            </tr>';

                                }else if($res["sede"]==1 && $res["departamento"]==1){
                                    echo '<tr>
                                <td>'.$res["celular"].'</td>
                                <td>'.$res["correo"].'</td>
                                <td>San Juan</td>
                            ...
                            else if($res["sede"]==1 && $res["departamento"]==3){
                                echo '<tr>
                            <td>'.$res["celular"].'</td>
                            <td>'.$res["correo"].'</td>
                            <td>San Juan</td>
                        ...
                        else if($res["sede"]==2 && $res["departamento"]==2){
                            echo '<tr>
                        <td>'.$res["celular"].'</td>
                        <td>'.$res["correo"].'</td>
                        <td>Colores</td>
                        ...
                        <td><a href="#" data-href="eliminar_asesor.php?id='.$res["id"].'" data-toggle="modal" data-target="#confirm-delete" ><i class="fa fa-times style="color:#fff;" nav_icon"></i></a></td>
                    ...
                    else if($res["sede"]==2 && $res["departamento"]==1){
                                                    echo '<tr>
                                                <td>'.$res["celular"].'</td>
                                                <td>'.$res["correo"].'</td>
                                                <td>Colores</td>
                    ...
                    else if($res["sede"]==2 && $res["departamento"]==3){
                                                echo '<tr>
                                            <td>'.$res["celular"].'</td>
                                            <td>'.$res["correo"].'</td>
                                            <td>Colores</td>
                    ...
                    else if($res["sede"]==3 && $res["departamento"]==2){
                                            echo '<tr>
                                        <td>'.$res["celular"].'</td>
                                        <td>'.$res["correo"].'</td>
                                        <td>Belen</td>
                    ...
                    else if($res["sede"]==3 && $res["departamento"]==1){
                                        echo '<tr>
                                    <td>'.$res["celular"].'</td>
                                    <td>'.$res["correo"].'</td>
                                    <td>Belen</td>
                    ...
                    else if($res["sede"]==3 && $res["departamento"]==3){
                                        echo '<tr>
                                    <td>'.$res["celular"].'</td>
                                    <td>'.$res["correo"].'</td>
                                    <td>Belen</td>
                    ...
                    else if($res["sede"]==4 && $res["departamento"]==2){
                                    echo '<tr>
                                <td>'.$res["celular"].'</td>
                                <td>'.$res["correo"].'</td>
                                <td>Centro</td>
                                ...
                                else if($res["sede"]==4 && $res["departamento"]==1){
                                    echo '<tr>
                                <td>'.$res["celular"].'</td>
                                <td>'.$res["correo"].'</td>
                                <td>Centro</td>
                                ...
                                else if($res["sede"]==4 && $res["departamento"]==3){
                                    echo '<tr>
                                <td>'.$res["celular"].'</td>
                                <td>'.$res["correo"].'</td>
                                <td>Centro</td>
                                ...
                                else if($res["sede"]==5 && $res["departamento"]==2){
                                    echo '<tr>
                                <td>'.$res["celular"].'</td>
                                <td>'.$res["correo"].'</td>
                                <td>Sur</td>
                                ...
                                else if($res["sede"]==5 && $res["departamento"]==1){
                                    echo '<tr>
                                <td>'.$res["celular"].'</td>
                                <td>'.$res["correo"].'</td>
                                <td>Sur</td>
                                ...
                                else if($res["sede"]==5 && $res["departamento"]==3){
                                    echo '<tr>
                                <td>'.$res["celular"].'</td>
                                <td>'.$res["correo"].'</td>
                                <td>Sur</td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>¿Usted esta seguro que desea eliminar la información?</p>
                        </div>
