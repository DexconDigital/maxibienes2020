...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="col-md-12 graphs">
            ...
            <h3>Informacion de Asesores</h3>
      
                <div class="tab-pane active" >
     
                <form class="form-horizontal" method="post" action="guardar_asesor.php" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">Numero de Celular</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="celular" id="celular"  placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control1" name="correo" id="correo"  placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="disabledinput" class="col-sm-2 control-label">Sede</label>
                            <div class="col-sm-3">
                            <select class="form-control1" name="sede" id="sede" required>
                                <option value="0">Sede</option>
                                <option value="1">San Juan</option>
                                <option value="2">Colores</option>
                                <option value="3">Belen</option>
                        ...
                        <div class="form-group">
                            <label for="disabledinput" class="col-sm-2 control-label">Departamento al que pertenece</label>
                            <div class="col-sm-3">
                            <select class="form-control1" name="departamento" id="departamento" required>
