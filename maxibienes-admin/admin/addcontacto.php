...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="col-md-12 graphs">
            ...
            <h3>Informacion de Contenido</h3>
      
                <div class="tab-pane active" >
     
                    <form class="form-horizontal" method="post" action="guardar_content.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                            <select class="form-control1" name="zona" id="zona" required>
                                <option value="0">Ubicación en la Pagina</option>
                                <option value="1">Nuestra Compañia</option>
                                <option value="2">Footer</option>
                                <option value="3">Valores Corporativos</option>
                            <select>
                            </div>
                        </div>
