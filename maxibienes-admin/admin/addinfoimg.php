...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="col-md-12 graphs">
            ...
            <h3>Informacion de Contenido con Imagenes</h3>
      
                <div class="tab-pane active" >
     
                <form class="form-horizontal" method="post" action="guardar_contimg.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="disabledinput" class="col-sm-2 control-label">Ubicación en la Pagina</label>
                            <div class="col-sm-3">
                            <select class="form-control1 cambio" name="zona" id="zona" required>
                                <option value="0">Ubicación en la Pagina</option>
                                <option value="1">Zona Interactiva(Inicio)</option>
                                <option value="2">Servicios</option>
                                <option value="3">Modal Pagos (inicio)</option>
                        ...
                        <div class="form-group" id="url" style="display:none">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="link" id="link"  placeholder="" >
                            </div>
                        </div>
                        <div class="form-group">
    ...
    $(".cambio").change(function () {
        var opcion;
        opcion = $("#zona option:selected").val();
        if(opcion=="1"){
