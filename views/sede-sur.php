...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="parallax parallax-banner colored-bg pattern-bg" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="page-title">Maxibienes, Sede Sur</h1>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="section-title">Bienvenido a Nuestra sede de Sur</h1>
                    </div>
                    <!-- Mapa y contacto -->
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12 col-md-10 col-lg-8">
                                <?php include 'mapas-sedes/sede-sur.php' ?>
                            </div>
                                            ...
                                            if ($res11["sede"] == 5 && $res11["departamento"] == 2) {
                                                echo '<li class="col-md-6">
                                                                ...
                                                                <div class="info">
                                                                    ...
                                                                    <img src="' . $url_host . 'maxibienes-admin/admin/' . $res11["foto"] . '" class="img-sedes"></center>
                                                                    <h2></h2>
                                ...
                                <div data-tab-content="tab20">
                                    ...
                                    while ($res12 = mysqli_fetch_array($sql12)) {
                                        if ($res12["sede"] == 5 && $res12["departamento"] == 1) {
                                            echo '<li class="col-md-6 lista_sedes">


                                                                <div class="info">
                                                                    <center class="contenedor-img-tab">
                                                                    <img src="' . $url_host . 'maxibienes-admin/admin/' . $res12["foto"] . '" class="img-sedes"></center>
                                                                    <h2></h2>
                                    ...
                                    while ($res13 = mysqli_fetch_array($sql13)) {
                                        if ($res13["sede"] == 5 && $res13["departamento"] == 3) {
                                            echo '<li class="col-md-6">
                                                                ...
                                                                <div class="info">
                                                                    <center class="contenedor-img-tab">
                                                                    <img src="' . $url_host . 'maxibienes-admin/admin/' . $res13["foto"] . '" class="img-sedes"></center>
                                                                    <h2></h2>
        ...
        <div class="parallax pattern-bg" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="section-title" data-animation-direction="from-bottom" data-animation-delay="50">Propiedades Destacadas Sede Sur</h2>
                        <div class="container">
                            <div class="row">
                    ...
                    <div class="col-sm-12">
                        <a href="<?php echo $url_host ?>/lista-de-inmuebles-sede/sur/" class="btn btn-danger ml-4 mt-4">Ver todos los inmuebles de la sede</a>
                    </div>
                </div>
            </div>
        </div>
        <section>
            <div class="container">
                <div class="main">
                    ...
                    <form action="<?php echo $url_host ?>js/mailSur.php" method="POST">
                        <div class="col-sm-12">
    ...
    <script src="<?php echo $url_host ?>js/des-sur.js"></script>
