...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="parallax parallax-banner colored-bg pattern-bg" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="page-title">Maxibienes, Sede San Juan</h1>

                        <ul class="breadcrumb">
                            <li><a href="./">Inicio</a></li>
                            <li><a href="">Sede San Juan</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="section-title">Bienvenido a Nuestra sede de San Juan</h1>
                    </div>
                    <!-- Mapa y contacto -->
        <div class="col-sm-12">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8">
                    <?php include 'mapas-sedes/sede-sanjuan.php' ?>
                </div>
                <div class="col-sm-12 col-sm-10 col-lg-4" style="font-size: 1.3rem;">
                    ...
                    <p><i class="fa fa-calendar"></i> Lunes a Viernes: de 8:00 a.m. a 6:00 p.m. Jornada Continua
                    ...
                    <div data-tab-content="tab19">
                        <ul id="agencies-results" class="agencies-list">
                            ...
                            while ($res9 = mysqli_fetch_array($sql9)) {
                                if ($res9["sede"] == 1 && $res9["departamento"] == 2) {
                    ...
                    <div data-tab-content="tab20">
                        <ul id="agencies-results" class="agencies-list">
                            ...
                            while ($res8 = mysqli_fetch_array($sql8)) {
                                if ($res8["sede"] == 1 && $res8["departamento"] == 1) {
                                    echo '<li class="col-md-6">
                                                    <div class="info">
                                                        <center class="contenedor-img-tab">
                    ...
                    <div data-tab-content="tab21">
                        <ul id="agencies-results" class="agencies-list">
                            ...
                            while ($res10 = mysqli_fetch_array($sql10)) {
                                if ($res10["sede"] == 1 && $res10["departamento"] == 3) {
                                    echo '<li class="col-md-6">
                                                    <div class="info">
                                                        <center class="contenedor-img-tab">
    ...
    <div class="parallax pattern-bg">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="section-title" data-animation-direction="from-bottom" data-animation-delay="50">Propiedades Destacadas Sede San Juan</h2>
                    <div class="container">
                        <div class="row ">
                            <div class="col-12 col-md-10 col-lg-12" id="columna-destacadas">
                ...
                <div class="col-sm-12">
                    <a href="<?php echo $url_host ?>/lista-de-inmuebles-sede/san-juan/" class="btn btn-danger ml-4 mt-4">Ver todos los inmuebles de la sede</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo $url_host ?>js/destacadas-san-juan.js"></script>
