    ...
    <div id="wrapper">
        ...
        <div class="parallax parallax-banner colored-bg pattern-bg" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="page-title">Maxibienes, Sede Belén</h1>

                        <ul class="breadcrumb">
                            <li><a href="./">Inicio</a></li>
                            <li><a href="">Sede Belén</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="section-title">Bienvenido a Nuestra sede Belén</h1>
                    </div>
                    <!-- Mapa y contacto -->
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12 col-md-10 col-lg-8">
                                <?php include 'mapas-sedes/sede-belen.php' ?>
                            </div>
                                            ...
                                            if ($res6["sede"] == 3 && $res6["departamento"] == 2) {
                                                echo '<li class="col-md-6">
                                                                <div class="info">
                                                                    ...
                                                                    <img src="' . $url_host . 'maxibienes-admin/admin/' . $res6["foto"] . '" class="img-sedes"></center>
                                                                    <h2></h2>
                                    ...
                                    while ($res7 = mysqli_fetch_array($sql7)) {
                                        if ($res7["sede"] == 3 && $res7["departamento"] == 1) {
                                            echo '<li class="col-md-6">
                                                                <div class="info">
                                                                    <center class="contenedor-img-tab">
                                                                    <img src="' . $url_host . 'maxibienes-admin/admin/' . $res7["foto"] . '" class="img-sedes"></center>
                                                                    <h2></h2>
        ...
        <div class="parallax pattern-bg" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="section-title" data-animation-direction="from-bottom" data-animation-delay="50">Propiedades Destacadas Sede Belén</h2>
                        <div class="container">
                            <div class="row ">
                    ...
                    <div class="col-sm-12">
                        <a href="<?php echo $url_host ?>/lista-de-inmuebles-sede/belen/" class="btn btn-danger ml-4 mt-4">Ver todos los inmuebles de la sede</a>
                    </div>
                </div>
            </div>
        </div>
        <section>
            <div class="container">
                <div class="main">
                    ...
                    <form action="<?php echo $url_host ?>js/mailBelen.php" method="POST">
                        <div class="col-sm-12">
