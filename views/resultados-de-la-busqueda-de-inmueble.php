...
<?php
require 'controllers/resultadoController.php'; ?>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="container">
			<div class="col-12">
				<h2 class="text-center titulo-inmuebles mt-4 mb-4 pt-4 pb-4">Resultado de la busqueda de inmuebles
				</h2>
			</div>
		</div>
		<div class="container">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div class="gray open main" style="margin-top:15%;">
					<h2 class="text-center mb-4">Busca tu inmueble</h2>
					<div class="form-group">
						<div class="form-control-large">
							<input type="text" class="form-control codeInm" name="location" placeholder="Codigo">
						</div>
						...
						<div class="form-group">
							...
							<div class="form-control-large">
								<input type="number" class="form-control areamin" placeholder="Area Minima">
							</div>
							<div class="form-control-large">
								<input type="number" class="form-control areamax" placeholder="Area Maxima">
							</div>
							<div class="form-control-small">
								<button type="button" class="btn btn-fullcolor buscar" id="buscar">Buscar</button>
							</div>
						</div>
					</div>
				</div>
	...
	<script src="<?php echo $url_host ?>js/paginadorResultados.js"></script>
	<div id="fb-root"></div>
	<script>
